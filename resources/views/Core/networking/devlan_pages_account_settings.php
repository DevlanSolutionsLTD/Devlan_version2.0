                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="devlan_pages_nw_commits_dashboard.php">Account</a></li>
                                                <li class="breadcrumb-item active">Update Account</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">@<?php echo $row->user_number;?> Update Your DevLan Account</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="sub-header">
                                            Update your account for better discoverability by fellow DevLanner's 😸 
                                            </p>
