                    ...
                    <div class="content">
                        ...
                        <div class="container-fluid">
                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">PacketTracer</a></li>
                                                <li class="breadcrumb-item active">View Commits</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">PacketTracer  Commits
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card-box">
                                        <h4 class="header-title">All PacketTracer Commits</h4>
                                        <div class="mb-2">
                                            <div class="row">
                                            ...
                                            <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                                ...
                                                <tbody>
                                                    <?php
                                                            ...
                                                            //$user_id = $_SESSION['user_id'];
                                                            $ret="SELECT  * FROM  projects WHERE  project_category = 'Packet Tracer Topologies' ";
                                                            $stmt= $mysqli->prepare($ret) ;
                                                            //$stmt->bind_param('i',$user_id);
                                                            $stmt->execute() ;//ok
                                                            $res=$stmt->get_result();
