                    ...
                    <div class="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Progressive Web Apps  Commits
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card-box">
                                        <h4 class="header-title">Progressive Web Apps Commits</h4>
                                            ...
                                            <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                                ...
                                                <tbody>
                                                    <?php
                                                            ...
                                                            //$user_id = $_SESSION['user_id'];
                                                            $ret="SELECT  * FROM  projects WHERE  project_category = 'Progressive WebApp' ";
                                                            $stmt= $mysqli->prepare($ret) ;
                                                            //$stmt->bind_param('i',$user_id);
                                                            $stmt->execute() ;//ok
                                                            $res=$stmt->get_result();
