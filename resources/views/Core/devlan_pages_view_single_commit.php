                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane show active" id="screenshot">
                                               <img class="img-fluid" src = "assets/projects/<?php echo $row->project_avatar;?>"></img>
                                            </div>
                                            <div class="tab-pane " id="details">
                                                ...
                                                <b> View
                                                    <a class="badge badge-primary" href="devlan_pages_view_commit_owner.php?user_id=<?php echo $row->user_id;?>">
