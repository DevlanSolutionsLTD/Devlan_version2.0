                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">DevLanners</a></li>
                                                <li class="breadcrumb-item active">Manage </li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Joined DevLanners
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="devlan_sudo_pages_view_single_devlanner.php?user_id=<?php echo $row->user_id;?>">
                                                                    <span class="btn label-table btn-outline-success btn-sm">
                                                                        <i class="fa fa-eye"></i> <i class="fa fa-user mr-1"></i>
                                                                            View
                                                                    </span>
                                                                </a>
                                                                <a href="devlan_sudo_pages_update_single_devlanner.php?user_id=<?php echo $row->user_id;?>">    
                                                                    <span class="btn label-table btn-outline-warning btn-sm">
                                                                        <i class="fa fa-edit"></i> <i class="fa fa-user mr-1"></i>
                                                                            Update
                                                                    </span>
                                                                </a>
                                                                <a href="devlan_sudo_pages_manage_devlanners.php?delete_user=<?php echo $row->user_id;?>">    
                                                                    <span class="btn label-table btn-outline-danger btn-sm">
                                                                        <i class="fa fa-trash"></i> <i class="fa fa-user mr-1"></i>
                                                                            Delete
                                                                    </span>
                                                                </a>    
                                                            </td>
