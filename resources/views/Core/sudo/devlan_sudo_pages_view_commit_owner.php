                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="devlan_sudo_pages_manage_commits.php">Commits</a></li>
                                                ...
                                                <ul class="list-unstyled timeline-sm">
                                                    ...
                                                    ?>
                                                        <li class="timeline-sm-item">
                                                            ...
                                                            <!--View Commit-->
                                                            <a href="devlan_sudo_pages_view_single_commit.php?project_id=<?php echo $row->project_id;?>" class="float-right btn btn-outline-info"><i class="fa fa-eye"></i> <i class="mdi mdi-source-pull"></i> View Commit</a><br>
