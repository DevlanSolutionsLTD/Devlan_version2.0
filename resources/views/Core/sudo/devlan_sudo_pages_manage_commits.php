                                    ...
                                    <div class="page-title-box">
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                ...
                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Commits</a></li>
                                                <li class="breadcrumb-item active">View Commits</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">All Devlan Commits
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="devlan_sudo_pages_view_single_commit.php?project_id=<?php echo $row->project_id;?>">
