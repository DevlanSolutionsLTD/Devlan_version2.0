        ...
        if(isset($_POST['push_notification']))
            {
                ...
                $query="INSERT INTO notifications (user_id, n_name, n_desc, n_number, n_from, n_status) VALUES(?,?,?,?,?,?)";
                $stmt = $mysqli->prepare($query);
                //bind the submitted values with the matching columns in the database.
                $rc=$stmt->bind_param('ssssss',$user_id, $n_name, $n_desc, $n_number, $n_from, $n_status);
                $stmt->execute();
                                                    ...
                                                    <form method="POST" enctype="multipart/form-data" >
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-6 mb-3">
                                                                ...
                                                                <input type="text" required name="n_name"  id="simpleinput" class="form-control">
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-12 mb-3">
                                                                ...
                                                                <textarea type="text" required name="n_desc"  id="notification_body" class="form-control"></textarea>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-12 mb-3">
                                                                <section class="progress-demo">
                                                                    <button  name="push_notification" type="submit" class="ladda-button pull-right ladda-button-demo btn btn-outline-success"  data-style="zoom-in">Push Notification</button>
                                                                </section>
                                                            </div>
                                                        </div>
